{
  ...
  hotkeys.commands = {
    ...
    shortcuts = {
      ...
      kwin."Window One Desktop to the Left" = ["Ctrl+Alt+Shift+Left" "Meta+Ctrl+Shift+Left"];
      kwin."Window One Desktop to the Right" = ["Ctrl+Alt+Shift+Right" "Meta+Ctrl+Shift+Right"];
      ...
      "services/net.local.ulauncher-4.desktop"._launch = ["Menu" "Alt+Space"];
    ...
    configFile = {
      ...
      ksplashrc.KSplash.Theme = "org.kde.oxygen";
      ...
      spectaclerc.Annotations.freehandStrokeColor = "255,255,255";
      spectaclerc.Annotations.freehandStrokeWidth = 48;
