...
in {
  services.minecraft-servers.servers.proxy = {
    ...
    symlinks."plugins/LibreLoginNext.jar" = pkgs.fetchurl rec {
      ...
      version = "0.25.3";
      url = "https://github.com/MiguVerse/${pname}/releases/download/${version}/${pname}.jar";
      hash = "sha256-bH7Yp4pVHAqXJRgnp4wXJtxfEKJMpEiEyA8RTA/Q3Gk=";
    };
    files = {
      ...
      "plugins/librelogin/config.conf".value = {
        ...
        database = {
          ...
          port = config.services.mysql.replication.masterPort;
          user = "minecraft";
        };
        debug = false;
